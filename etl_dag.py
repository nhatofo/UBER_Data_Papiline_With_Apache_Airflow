...
"""
NOTE: create connection to connect to hive server 2 with name 'hiveserver2_default'
"""

create_hive_database = HiveOperator(task_id='create_hive_database', hql = hql_create_hive_database, hive_cli_conn_id = "hiveserver2_default", dag=etl_dag)
create_booking_raw_table = HiveOperator(task_id='create_booking_raw_table', hql = hql_create_booking_raw_table, hive_cli_conn_id = "hiveserver2_default", dag=etl_dag)
create_trip_raw_table = HiveOperator(task_id='create_trip_raw_table', hql = hql_create_trip_raw_table, hive_cli_conn_id = "hiveserver2_default", dag=etl_dag)
...
add_partitions_for_booking_table = HiveOperator(task_id='add_partitions_for_booking_table', hql = hql_add_partitions_for_booking_table, hive_cli_conn_id = "hiveserver2_default", dag=etl_dag)
add_partitions_for_trip_table = HiveOperator(task_id='add_partitions_for_trip_table', hql = hql_add_partitions_for_trip_table, hive_cli_conn_id = "hiveserver2_default", dag=etl_dag)
...
create_filter_booking_table = HiveOperator(task_id='create_filter_booking_table', hql = hql_create_filter_booking_table, hive_cli_conn_id = "hiveserver2_default", dag=etl_dag)
create_filter_trip_table = HiveOperator(task_id='create_filter_trip_table', hql = hql_create_filter_trip_table, hive_cli_conn_id = "hiveserver2_default", dag=etl_dag)
...
filter_booking_table = SparkSubmitOperator(task_id='filter_booking_table', 
    application='/home/ec2-user/airflow_codes/uber/filter_booking.py', 
...
filter_trip_table = SparkSubmitOperator(task_id='filter_trip_table', 
    application='/home/ec2-user/airflow_codes/uber/filter_trip.py', 
    conn_id='spark_default', 
    spark_binary='spark2-submit',
    application_args=[ "{{ ds }}" ],
    dag=etl_dag)
...
create_car_with_most_trips_table = HiveOperator(task_id='create_car_with_most_trips_table', hql = hql_create_car_with_most_trips_table, hive_cli_conn_id = "hiveserver2_default", dag=etl_dag)
create_trip_throughput_table = HiveOperator(task_id='create_trip_throughput_table', hql = hql_create_trip_throughput_table, hive_cli_conn_id = "hiveserver2_default", dag=etl_dag)

generate_car_with_most_trips = SparkSubmitOperator(task_id='generate_car_with_most_trips', 
    application='/home/ec2-user/airflow_codes/uber/generate_car_with_most_trips.py', 
    conn_id='spark_default', 
    spark_binary='spark2-submit',
    application_args=[ "{{ ds }}" ],
    dag=etl_dag)
...
generate_trip_throughput = SparkSubmitOperator(task_id='generate_trip_throughput', 
    application='/home/ec2-user/airflow_codes/uber/generate_trip_throughput.py', 
    conn_id='spark_default', 
    spark_binary='spark2-submit',
    application_args=[ "{{ ds }}" ],
    dag=etl_dag)
...
[create_filtered_booking_location, create_filtered_trip_location] >> create_result_trip_throughput_location
